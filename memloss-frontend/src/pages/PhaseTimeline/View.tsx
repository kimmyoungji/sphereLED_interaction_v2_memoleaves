...
export default function PhaseTimeline(){
  ...
  const captions: { ko: string; en: string }[] = [
    ...
    { ko: '잠자리를 많이 잡으러 다녔었어', en: 'I used to catch lots of dragonflies' },
  ...
  const markers = useMemo(() => {
  // Example: denser at the end
  console.log(captions.length);
  const m: number[] = [
    0.00, 0.03, 0.06, 0.10, 0.14, 0.35, 0.38, 0.42, 0.46, 0.50, 0.54, 0.58, 0.62, 0.66, 0.70,
    0.74, 0.78, 0.82, 0.86, 0.90, 0.94, 0.96, 0.975, 0.99, 1.00
  ];
  return m;
}, []);
